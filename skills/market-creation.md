...
context questions submit-and-wait "Will Bitcoin hit $200k by end of 2026?"
...
```bash
context questions submit "Will Ethereum flip Bitcoin by market cap in 2026?"
```
...
```bash
context questions status kF7bcVMOqRITbiQXRq8ir
```
...
```bash
context markets create 0x5bb7547ad70232d934458522ea2530d67447aaf26ff318b64c48e6da9c09e5c3
```
...
```bash
context questions submit-and-wait "Will Bitcoin hit $200k by end of 2026?" --poll-interval 2000 --max-attempts 45
```
...
context markets get 0xNewMarketId
